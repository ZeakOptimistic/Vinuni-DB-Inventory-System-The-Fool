...
The complete ERD for SIPMS is shown in Figure~\ref{fig:conceptual-erd} on page 3.
...
\begin{itemize}
  \item \textbf{Seed script.}
        A separate SQL file \texttt{database/seed\_data.sql} will contain
  ...
  \item \textbf{Reproducibility.}
        ...
        \texttt{seed\_data.sql} are version-controlled in the repository so
